...
# |-----------|--------|-------|-------------|-------|
# | α         | `α`    | 0.1   | скорость размножения жертв | 1/время |
# | β         | `β`    | 0.02  | интенсивность хищничества | 1/(время·хищник) |
# | δ         | `δ`    | 0.01  | эффективность конверсии жертв в хищников | 1/(время·жертва) |
# | γ         | `γ`    | 0.3   | смертность хищников | 1/время |
...
# Временные параметры: моделируем 200 единиц времени с шагом вывода 0.1
